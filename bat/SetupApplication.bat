...
:: Android packaging
set AND_CERT_NAME="Starling-timeline-example"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Starlingtimelineexample.p12
...
set IOS_PROVISION=cert\Starlingtimelineexample.mobileprovision
...
set APP_ID=air.Starlingtimelineexample

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Starlingtimelineexample
